...
f <- "/path/to/BLSF_CG_OHE_RF_NestedCVResults.csv"
p <- "/path/to/BLSF_CG_OHE_RF_NestedCVResults.pdf"
g <- "/path/to/BLSF_CG_OHE_RF_NestedCVResults.png"
...
ggplot(data= CV, mapping = aes(x=Statistic, y=Score)) + 
  ...
  labs(y = "Score", x = "Statistic", title = "Core SNVs") +
