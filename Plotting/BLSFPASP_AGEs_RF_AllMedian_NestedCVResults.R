...
f <- "/path/to/BLSFPASP_AGEs_RF_AllMedian_GSCV_NestedCVResults.csv"
p <- "/path/to/BLSFPASP_AGEs_RF_AllMedian_GSCV_NestedCVResults.pdf"
g <- "/path/to/BLSFPASP_AGEs_RF_AllMedian_GSCV_NestedCVResults.png"
...
ggplot(data= CV, mapping = aes(x=Statistic, y=Score)) + 
  ...
  labs(y = "Score", x = "Statistic", title = "All-Isolates Median") +
