...
f <- "/path/to/BLSF_AGEs_RF_GSCV_NestedCVResults.csv"
p <- "/path/to/BLSF_AGEs_RF_GSCV_NestedCVResults.pdf"
g <- "/path/to/BLSF_AGEs_RF_GSCV_NestedCVResults.png"
...
ggplot(data= CV, mapping = aes(x=Statistic, y=Score)) + 
  ...
  labs(y = "Score", x = "Statistic", title = "Random Forest") +
