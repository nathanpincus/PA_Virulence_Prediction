...
CV_df.to_csv('BLSFPASP_AGEs_RF_AllMedian_GSCV_NestedCVResults.csv', index=False)
...
with open('BLSFPASP_AGEs_RF_AllMedian_GSCV_GridSearch.pkl', 'wb') as f:
    pickle.dump(RF_GridSearch_final, f)
with open('BLSFPASP_AGEs_RF_AllMedian_GSCV_Model.pkl', 'wb') as f:
    pickle.dump(RF_final, f)
with open('BLSFPASP_AGEs_RF_AllMedian_GSCV_Features.pkl', 'wb') as f:
    pickle.dump(X, f)
with open('BLSFPASP_AGEs_RF_AllMedian_GSCV_labels.pkl', 'wb') as f:
    pickle.dump(y, f)
...
file_lc = "BLSFPASP_AGEs_RF_AllMedian_LearningCurve_95CI.pdf"
