# # Predicting virulence (High/Low) of 25 PASP isolates using BLSF_noCF final GSCV-tuned RF model - trained on 10-mers feature set
...
# Load in GSCV object
with open("/path/to/BLSF_RF_GSCV_10mers_GridSearch.pkl", "rb") as f:
    GSCV = pickle.load(f)
print("GSCV Object:")
print(GSCV)
...
# ### Load in PASP features (10mers)
PASP = pd.read_csv("/path/to/PASP_10mers.csv", index_col=0)
...
Scores.to_csv("PASP_VirulencePredictions_BLSF_RF_10mers.csv", index=False)

# Plot ROC curve
print("Plot AUC curve:")
file_auc = "PASP_VirulencePredictions_BLSF_RF_10mers_AUC.pdf"
...
PASP["pred"] = ypred
Comp = PASP[["rank","pred"]]
Comp.to_csv("PASP_virrank_vs_prediction_10mers.csv")
